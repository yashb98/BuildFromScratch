...
MODEL_FILE = r"/home/yashb98/Downloads/BuildFromScratch/Qwen3-0.6B/builds/2026-06-08_reproduce-exploratory_qwen3-0.6b/model_partialrope.py"         # absolute path to the build's model file
...
TARGET_CKPT = r"/home/yashb98/Downloads/BuildFromScratch/Qwen3-0.6B/builds/2026-06-08_reproduce-exploratory_qwen3-0.6b/results/checkpoint_prope25_2tpp_.pt"       # checkpoint under evaluation (absolute)
...
OUT_DIR = r"/home/yashb98/Downloads/BuildFromScratch/Qwen3-0.6B/experiments/2026-06-16_qwen3-0.6b_eval-prope25/eval"               # <MODEL_DIR>/experiments/<RUN_ID>/eval
...
def build_model(mod):
    ...
    return getattr(mod, MODEL_CLASS)(getattr(mod, CONFIG_CLASS)(partial_rotary_factor=0.25))
